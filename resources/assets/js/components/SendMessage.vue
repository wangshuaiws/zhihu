<template>
    <div>
        <button class="btn btn-default pull-right" style="margin-top: -36px;" @click="showSendMessageForm">
            发送私信
        </button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <textarea name="body" class="form-control" v-model="body" cols="30" rows="10" v-if="!status"></textarea>
